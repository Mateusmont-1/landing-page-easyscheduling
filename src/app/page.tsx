    ...
    <div className="flex flex-col h-full md:py-36 md:px-32 pt-11 pb-24 px-8 w-full items-center text-center gap-12">
      ...
      <div className="flex flex-col gap-6 items-center">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-center w-full">
          {[
            { question: 'Como funciona o período de teste?', answer: 'Oferecemos um período de teste de 14 dias para você experimentar todas as funcionalidades do sistema.' },
            { question: 'Posso cancelar a qualquer momento?', answer: 'Sim, você pode cancelar sua assinatura a qualquer momento sem nenhum custo adicional.' }
